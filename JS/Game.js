class Game {
    ...
    showLife() {
        push();
        image(life, width / 2 - 130, height - player.positionY - 275, 20, 20);
        fill("white");
    ...
    showOxygenBar() {
        push();
        image(oxygen, width / 2 - 170, height - player.positionY - 100, 70, 40);
        fill("white");
        rect(width / 2 - 100, height - player.positionY - 100, 185, 20);
        fill("pink");
        rect(width / 2 - 100, height - player.positionY - 100, player.powerUp, 20);
        noStroke();
        pop();
    }
